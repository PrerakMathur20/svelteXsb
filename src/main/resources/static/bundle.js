var app = (function () {
	...
	/* src/app/pages/About.svelte generated by Svelte v3.1.0 */

	const file$3 = "src/app/pages/About.svelte";
	...
	function create_fragment$4(ctx) {
		...
		return {
			c: function create() {
				...
				add_location(main, file$4, 31, 0, 602);
			},
	...
	class RouterLink extends SvelteComponentDev {
		constructor(options) {
			super(options);
			init(this, options, instance$2, create_fragment$5, safe_not_equal, ["url"]);
	...
	function create_fragment$6(ctx) {
		...
		return {
			c: function create() {
				...
				add_location(li1, file$6, 27, 4, 401);
